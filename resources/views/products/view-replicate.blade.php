...
@section('content')
<div class="row">
    <h2 class="text-center">Replicate to a new product</h2>
    ...
    <form method="POST" action="{{ route('products.replicate', $product->id) }} " class="d-grid gap-2 col-6 mx-auto bg-light">
        @csrf
